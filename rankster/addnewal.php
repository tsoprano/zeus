...
if(strpos($url,'error=empty')!==false){
	...
	if(strpos($url,'error=alal')!==false){
		echo 'PLAYER IS ALREADY A BOWLER OR A BATSMAN. PLAYER IS EITHER A BOWLER, OR A BATSMAN, OR AN ALLROUNDER!';
	}
...
<form action='includes/addnewal.inc.php' method='POST'>

  <h4>Who is your all-rounder?</h4>
  <div>
  
		<qav>
			  All-rounder Name
			  <input type='text' name='bmname' placeholder='Viv Richards'><br> Date of Birth
			  <input type='date' name='dob' placeholder='yyyy-mm-dd'><br> Country
			  <input type='text' name='tname' placeholder='West Indies'><br> Handed
			  <div class='contain'>	
	...
	<h4>Game format?</h4>
											<qav>
														<div class='container'>
															...
															<div class='container reveal-if-active' id='odi' ><input type='integer' name='100s1' placeholder='100s'><br></div>
	...
	<qav>													
	<input type='integer' name='innings1' placeholder='INNINGS'><br>
           <input type='integer' name='wickets' placeholder='WICKETS'><br>
            <input type='float' name='avg1' placeholder='AVERAGE'><br>
             <input type='float' name='sr1' placeholder='STRIKE-RATE'><br>
