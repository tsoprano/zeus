...
if ($hand=='-'){
	if($cp=='bl'){
		if($blt=='-'){
							...
							$sql="SELECT bltest.*,player.pid,type.*
							FROM type
							left JOIN player
							ON type.pid=player.pid
							right join bltest ON player.pname=bltest.blname
							 ";
							$result= mysqli_query($conn,$sql);

							if (mysqli_num_rows($result) > 0) {
							echo "<h1>TEST RANKINGS</h1>";
...
echo "</tr></tbody>";
	...
	elseif($cp=='bm'){
								if($bmt=='-'){
									...
									$sql="SELECT bmtest.*,player.pid,type.*
									FROM type
									left JOIN player
									ON type.pid=player.pid
									right join bmtest ON player.pname=bmtest.bmname
									 ";
						$result= mysqli_query($conn,$sql);
		...
		if($hand=='left'){
			if($cp=='bm'){if($bmt=='opener'){$sql="SELECT bmtest.*,player.pid,type.*
							FROM type
							left JOIN player
							ON type.pid=player.pid
							right join bmtest ON player.pname=bmtest.bmname
			...
			if($bmt=='top-order'){$sql="SELECT bmtest.*,player.pid,type.*
								FROM type
								left JOIN player
								ON type.pid=player.pid
								right join bmtest ON player.pname=bmtest.bmname
			...
			if($bmt=='middle-order'){$sql="SELECT bmtest.*,player.pid,type.*
								FROM type
								left JOIN player
								ON type.pid=player.pid
								right join bmtest ON player.pname=bmtest.bmname
			...
			if($bmt=='-'){$sql="SELECT bmtest.*,player.pid,type.*
							FROM type
							left JOIN player
							ON type.pid=player.pid
							right join bmtest ON player.pname=bmtest.bmname
			...
			elseif($cp=='bl'){
				if($blt=='fast'){$sql="SELECT bltest.*,player.pid,type.*
									FROM type
									left JOIN player
									ON type.pid=player.pid
									right join bltest ON player.pname=bltest.blname
			...
			if($blt=='fast-medium'){$sql="SELECT bltest.*,player.pid,type.*
										FROM type
										left JOIN player
										ON type.pid=player.pid
										right join bltest ON player.pname=bltest.blname
			...
			if($blt=='slow-finger-spin'){$sql="SELECT bltest.*,player.pid,type.*
									FROM type
									left JOIN player
									ON type.pid=player.pid
									right join bltest ON player.pname=bltest.blname
			...
			if($blt=='slow-wrist-spin'){$sql="SELECT bltest.*,player.pid,type.*
										FROM type
										left JOIN player
										ON type.pid=player.pid
										right join bltest ON player.pname=bltest.blname
			...
			if($blt=='-'){$sql="SELECT bltest.*,player.pid,type.*
									FROM type
									left JOIN player
									ON type.pid=player.pid
									right join bltest ON player.pname=bltest.blname
