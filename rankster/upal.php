...
FormStuff.init();
							...
							echo"
							<qav>
								<form action='includes/upal.inc.php' method='POST'>
										<h4>Game format?</h4>
											<qav>
														<div class='container'>
										...
										<h4>Which all-rounder do you want to update?</h4>
										...
										<h4>Batting Details</h4>
																	  Innings
																	  <input type='integer' name='innings' placeholder='80'><br> 
																	  Runs
																	  <input type='integer' name='runs' placeholder='6996'><br> 
																	  Average
																	  <input type='float' name='avg' placeholder='62.4'><br>
																	  Strike Rate
																	  <input type='float' name='sr' placeholder='62.4'><br>
																	  Fifties
																	  <input type='integer' name='50s' placeholder='13'><br> 
																	  Centuries(not reqd. for t20)
																	  <input type='integer' name='100s' placeholder='29'><br>
																	  Sixes(fill only for t20)
																	  <input type='integer' name='sixes' placeholder='13'><br> 
																	  Fours(fill only for t20)
																	  <input type='integer' name='fours' placeholder='13'><br> 
